...
La versión aplica los valores numéricos editados en [CADENA-DE-PRODUCCION.md](CADENA-DE-PRODUCCION.md), incluidos los cambios en filas antes rotuladas «Conservar». Las recetas principales permiten hasta 100 unidades de combustible por 1 de petróleo, 100 químicos por 1 de combustible y 10 de acero por 1 de mineral de hierro (más sus insumos secundarios). También aumentan las capacidades por instalación de diez materias primas y de la leche/carne. Los recursos a granel se muestran en unidades de juego (`u`), no toneladas físicas.

Las instalaciones, personal, energía, depósito y almacén siguen limitando la producción efectiva. Los depósitos e inventarios de partidas anteriores mantienen sus cifras; el nuevo rendimiento afecta solo ciclos futuros. Los precios y consumos existentes se mantienen para poder evaluar el balance en partidas reales. Aumentar capacidad extractiva puede acelerar el agotamiento de un depósito si se produce a plena carga.
...
- La central de madera usa 0,9 u/MWh, compite con otros usos de la madera y genera una pequeña penalización ambiental. El compostaje convierte 3 u orgánicas en hasta 1 u de biomasa con energía, personal, espacio y gasto. La ficha de residuos explica reciclado, tratamiento y costo de exportación.
