(function (root, factory) {
  ...
  // Game-equivalent daily rations per resource unit, not real nutritional advice.
  ...
  D.constructions.push(
    ...
    building("compost_plant", "Planta de compostaje", "services", "biomass",
      { treatment: 9000, landHa: 5, fixedCost: 0.012,
        description: "Convierte 3 u de residuo orgánico en hasta 1 u de biomasa; necesita energía y personal." }),
