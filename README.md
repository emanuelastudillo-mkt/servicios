# Pulso Global v5.4 - paquete para GitHub Pages
...
- El resultado fiscal ahora tiene efecto monetario real. Un superávit recupera primero las reservas negativas, después amortiza deuda y finalmente acumula el excedente en reservas. Un déficit consume reservas positivas y solo la parte no cubierta se convierte en deuda.
- Se elimina el piso artificial de `-20 MM`: ya no hay un valor negativo oculto ni una cifra congelada por el motor.
- En **Economía y deuda** se detallan el flujo fiscal mensual, el impacto comercial sobre reservas, el cambio efectivo de reservas, la amortización por superávit y la deuda emitida para cubrir déficit.
